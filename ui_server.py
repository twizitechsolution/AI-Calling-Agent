...
app = FastAPI(title="Twizitech Dashboard")
...
def read_config():
    ...
    return {
        "first_line": get_val("first_line", "FIRST_LINE", "Namaste! This is Aryan from Twizitech — we help businesses automate with AI. Hmm, may I ask what kind of business you run?"),
...
<head>
  ...
  <title>AI Voice Demo — Twizitech</title>
...
<body>
  <div class="card">
    ...
    <h1>Talk to Aryan</h1>
    <div class="sub">AI-powered multilingual consultant · Twizitech</div>
...
try:
    ...
    # Clear previously registered metrics on Uvicorn reload
    for collector in list(REGISTRY._collector_to_names.keys()):
        if any(name.startswith("voice_") for name in REGISTRY._collector_to_names[collector]):
...
<nav id="sidebar">
  <div class="sidebar-brand">
    ...
    <div>
      ...
      <div class="brand-sub">Twizitech</div>
    </div>
  </div>
  ...
  <div id="page-agent" class="page">
    ...
    <div class="section-card">
      ...
      <div class="form-group">
        ...
        <input type="text" id="first_line" value="{config.get('first_line', '')}" placeholder="Namaste! This is Aryan from Twizitech...">
...
function renderLangGrid() {{
  ...
  grid.innerHTML = Object.entries(LANG_PRESETS).map(([id, p]) => `
    ...
    " onmouseover="this.style.borderColor='${{p.color}}';" onmouseout="this.style.borderColor='';">
